...
```
    cd "CARRDS.Lambda.ProjectDeployment"
    dotnet restore
```

Execute unit tests
```
    cd "CARRDS.Lambda.ProjectDeployment/test/CARRDS.Lambda.ProjectDeployment.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CARRDS.Lambda.ProjectDeployment/src/CARRDS.Lambda.ProjectDeployment"
