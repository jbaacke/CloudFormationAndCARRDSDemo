...
```
    cd "CARRDS.Lambda.RemoveSubnets"
    dotnet restore
```

Execute unit tests
```
    cd "CARRDS.Lambda.RemoveSubnets/test/CARRDS.Lambda.RemoveSubnets.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CARRDS.Lambda.RemoveSubnets/src/CARRDS.Lambda.RemoveSubnets"
