...
```
    cd "CARRDS.Lambda.StackStreamResponse"
    dotnet restore
```

Execute unit tests
```
    cd "CARRDS.Lambda.StackStreamResponse/test/CARRDS.Lambda.StackStreamResponse.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CARRDS.Lambda.StackStreamResponse/src/CARRDS.Lambda.StackStreamResponse"
