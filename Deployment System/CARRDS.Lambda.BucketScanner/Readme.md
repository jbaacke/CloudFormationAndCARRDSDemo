...
```
    cd "CARRDS.Lambda.BucketScanner"
    dotnet restore
```

Execute unit tests
```
    cd "CARRDS.Lambda.BucketScanner/test/CARRDS.Lambda.BucketScanner.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CARRDS.Lambda.BucketScanner/src/CARRDS.Lambda.BucketScanner"
