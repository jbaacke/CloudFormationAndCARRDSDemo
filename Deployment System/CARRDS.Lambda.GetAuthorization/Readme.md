...
```
    cd "CARRDS.Lambda.GetAuthorization"
    dotnet restore
```

Execute unit tests
```
    cd "CARRDS.Lambda.GetAuthorization/test/CARRDS.Lambda.GetAuthorization.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CARRDS.Lambda.GetAuthorization/src/CARRDS.Lambda.GetAuthorization"
