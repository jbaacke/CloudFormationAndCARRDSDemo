...
```
    cd "CFVPCDemo.Lambda.AttachedLambda"
    dotnet restore
```

Execute unit tests
```
    cd "CFVPCDemo.Lambda.AttachedLambda/test/CFVPCDemo.Lambda.AttachedLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "CFVPCDemo.Lambda.AttachedLambda/src/CFVPCDemo.Lambda.AttachedLambda"
